...
class PostComment extends StatefulHookWidget {
  ...
  PostComment({Key? key, this.CommentId, this.ImageID, this.merchantId, this.imageUrl}) : super(key: key);
      ...
      child: Container(
        ...
        child: Container(
            ...
            child: FutureBuilder<GetCommentData>(
              future: _getcommentProvider.getCommentData(ImageID: widget.ImageID.toString()),
                  ...
                  return Column(
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(fontSize: 20, letterSpacing: 1, fontFamily: 'bold'),
                      ),
                      Text(
                        "Photos",
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              CircleAvatar(
                                                radius: 10,
                                                backgroundImage: data.comments[index].avatar.isNotEmpty
                                                    ? NetworkImage("${data.comments[index].avatar}")
                                                    : NetworkImage(
                                              ...
                                              Container(
                                                ...
                                                child: Text(
                                                  ...
                                                  style: TextStyle(fontSize: 16, color: Color(0xff173143), fontFamily: 'bold'),
                                                ),
                                              ),
                                            ],
                                          ),
                                          Text(
                                            ...
                                            style: TextStyle(fontSize: 10, color: Color(0xff9d9d9d), fontFamily: 'medium'),
                                          ),
                                        ],
                                      ),
                                      Container(
                                        ...
                                        child: Text(
                                          ...
                                          style: TextStyle(fontSize: 12, fontFamily: 'medium', color: thirdColor),
                                        ),
                                      ),
                                    ],
                                  );
                          ...
                          child: Row(
                            children: [
                              CircleAvatar(
                                ...
                                backgroundImage: NetworkImage(_userProvider.userData.avatar != null
                                ...
                                children: [
                                  Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(hintText: "Typing your comment...", hintStyle: TextStyle(color: Colors.grey)),
                                      )),
                                  IconButton(
                                    onPressed: () {
