          ...
          children: [
            ...
            InkWell(
              onTap: () async {
                ...
                notifications.sendNotification(deviceId: fcmToken.toString());
                log(deviceId);
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (_) => BaseHomeWidget())); // TODO: after testing remove this

                Navigator.push(context, MaterialPageRoute(builder: (_) => BaseHomeWidget()));
              },
              child: Container(
